class PythonAT312 < Formula
  ...
  # NOTE: ipatch, use macports idea for disabling tcl-tk aka tkinter
  patch do
    url "https://raw.githubusercontent.com/Homebrew/homebrew-core/5024d5b785db171580f43ce223e0eb6a3b6a0c45/patches/python-3.12-disable-tkinter.patch"
    sha256 ""
  end
